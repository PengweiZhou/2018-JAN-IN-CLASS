...
var featureImage = document.querySelector('a.link.feature');
...
featureLink.featureImageListener('click', featureImageListener);


function featureImageListener2(evt){
    var paragraph = document.querySelector('p.feature.title')
    paragraph.innerHTML = ''
    paragraph.classList.add('hidden')
}

featureImage.addEventListener('mouseout', featureImageListener2)